...
urlpatterns = [
    ...
    path('student/api/auto-checkin/', views.api_student_auto_checkin, name='api_student_auto_checkin'),
    ...
    # Proliz OBS Integration
    path('proliz/settings/', views.proliz_settings, name='proliz_settings'),
    path('proliz/sync/', views.proliz_sync, name='proliz_sync'),
    ...
    path('teacher/api/projector/<int:session_id>/toggle-ip/', views.toggle_ip_check, name='toggle_ip_check'),
    path('teacher/api/projector/<int:session_id>/toggle-qr/', views.toggle_qr_check, name='toggle_qr_check'),
    path('teacher/session/<int:session_id>/close/', views.close_attendance_session, name='close_attendance_session'),
    path('teacher/session/<int:session_id>/sync-proliz/', views.sync_session_to_proliz, name='sync_session_to_proliz'),
