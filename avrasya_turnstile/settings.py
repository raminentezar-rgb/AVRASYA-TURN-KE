"""
Django settings for avrasya_turnstile project.
...
WSGI_APPLICATION = 'avrasya_turnstile.wsgi.application'
...
# Supports SQLite and PostgreSQL based on DB_ENGINE env var
